class SubscribersController < ApplicationController
  ...
  skip_before_action :login_required, :only => %w(new create)
  before_action :admin_required, :only => %w(index destroy disable)
  before_action :find_subscriber, :only => %w(show edit update destroy disable)
